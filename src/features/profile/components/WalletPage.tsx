...
const WalletPage: React.FC = () => (
  <div>
    <h2 style={{ color: TEAL, fontSize: 24, fontWeight: 700, marginBottom: 22 }}>My Wallet</h2>
    ...
    <div style={{
      ...
      <div style={{ display: "flex", gap: 10 }}>
        <button style={{ padding: "7px 20px", borderRadius: 6, fontSize: 13, fontWeight: 600, background: "rgba(255,255,255,0.2)", border: "1px solid rgba(255,255,255,0.3)", color: "#fff", cursor: "pointer", fontFamily: "inherit" }}>
          Top Up
        </button>
        <button style={{ padding: "7px 20px", borderRadius: 6, fontSize: 13, fontWeight: 600, background: "rgba(0,0,0,0.15)", border: "1px solid rgba(255,255,255,0.2)", color: "#fff", cursor: "pointer", fontFamily: "inherit" }}>
          Withdraw
        </button>
      </div>
    </div>
