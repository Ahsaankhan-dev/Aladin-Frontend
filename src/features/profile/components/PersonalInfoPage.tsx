  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 28 }}>
        {/* Phone with flag */}
        <div>
          <label style={{ display: "block", fontSize: 14, color: "#333", marginBottom: 7 }}>
            Phone number
          </label>
          <div
            style={{
              display: "flex", alignItems: "center", border: "1px solid #c5c5c5",
              borderRadius: 6, background: "#fff", overflow: "hidden",
            }}
            onFocusCapture={e => {
              e.currentTarget.style.borderColor = TEAL;
              e.currentTarget.style.boxShadow = `0 0 0 3px rgba(28,138,158,0.12)`;
            }}
            onBlurCapture={e => {
        ...
        {/* DOB */}
        <div>
          <label style={{ display: "block", fontSize: 14, color: "transparent", marginBottom: 7, userSelect: "none" }}>
            -
          </label>
          <div style={{ position: "relative" }}>
            <input
              ...
              onChange={up("dob")}
              style={{
                width: "100%", padding: "11px 36px 11px 14px", fontSize: 14,
      ...
      <div style={{ display: "flex", gap: 12, marginBottom: 28 }}>
        ...
        <button
          ...
          style={{
            ...
            background: "#fff",
            border: `2px solid ${gender === "male" ? "#b0b0b0" : "#ddd"}`,
            display: "flex", flexDirection: "column", alignItems: "center",
            justifyContent: "center", gap: 8,
            boxShadow: gender === "male" ? "0 1px 8px rgba(0,0,0,0.13)" : "none",
            transition: "all 0.15s", fontFamily: "inherit",
          }}
        >
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke={TEAL} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <circle cx="10" cy="14" r="5"/>
            <line x1="19" y1="5" x2="14.14" y2="9.86"/>
            <polyline points="15 5 19 5 19 9"/>
          </svg>
          <span style={{ color: TEAL, fontWeight: 600, fontSize: 15 }}>Male</span>
        </button>
