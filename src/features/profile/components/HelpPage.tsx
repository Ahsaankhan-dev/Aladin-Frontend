// ══════════════════════════════════════════
//  profile/components/HelpPage.tsx
        ...
        {FAQS.map((f, i) => (
          <div key={i} style={{ border: "1px solid #e5e7eb", borderRadius: 8, overflow: "hidden" }}>
            ...
            >
              ...
              <span style={{ fontSize: 20, color: TEAL, transform: open === i ? "rotate(45deg)" : "none", transition: "transform 0.2s", marginLeft: 8, flexShrink: 0 }}>+</span>
            </button>
            {open === i && (
