// ══════════════════════════════════════════
//  profile/components/PaymentPage.tsx
    ...
    <>
      ...
      <div style={{ display: "flex", gap: 14, marginBottom: 24, flexWrap: "wrap" }}>
        ...
        <div style={{
          ...
          <div style={{ width: 30, height: 30, borderRadius: "50%", background: "#e5e5e5", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#777" strokeWidth="2.5"><path d="M12 5v14M5 12h14"/></svg>
          </div>
      ...
      {/* Card details form */}
      <div style={{ background: "#f9f9f9", borderRadius: 8, padding: "18px 18px 20px", border: "1px solid #eee", marginBottom: 20 }}>
        <div style={{ fontSize: 12, fontWeight: 700, color: TEAL, textTransform: "uppercase", letterSpacing: "0.07em", marginBottom: 14 }}>
          Card Details
        </div>
